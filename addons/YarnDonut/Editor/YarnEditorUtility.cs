...
namespace YarnDonut.Editor
{
    ...
    public static class YarnEditorUtility
    {
        ...
        const string TemplateFilePath = "res://addons/YarnDonut/Editor/YarnScriptTemplate.txt";
        ...
        {
            var newYarnProject = InstanceScript<YarnProject>("res://addons/YarnDonut/Runtime/YarnProject.cs");
        ...
        {
            var newLocalization =  InstanceScript<Localization>("res://addons/YarnDonut/Runtime/Localization.cs");
