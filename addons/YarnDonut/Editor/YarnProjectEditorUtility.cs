...
namespace YarnDonut.Editor
{
    ...
    public static class YarnProjectEditorUtility
    {
            ...
            if (scriptAbsolutePaths.Count > 0)
            {
                ...
                var newDeclarations = new List<Declaration>() //localDeclarations
                    ...
                    .Select(decl =>
                    {
                        ...
                        var serialized = existingDeclaration ?? YarnEditorUtility.InstanceScript<SerializedDeclaration>("res://addons/YarnDonut/Runtime/SerializedDeclaration.cs");
        ...
        public static FunctionInfo CreateFunctionInfoFromMethodGroup(MethodInfo method)
        {
            ...
            var info = YarnEditorUtility.InstanceScript<FunctionInfo>("res://addons/YarnDonut/Runtime/FunctionInfo.cs");
        ...
        private static void CreateYarnInternalLocalizationAssets(YarnProject project, CompilationResult compilationResult)
        {
            ...
            if (shouldAddDefaultLocalization)
            {
                ...
                developmentLocalization = YarnEditorUtility.InstanceScript<Localization>("res://addons/YarnDonut/Runtime/Localization.cs");
        ...
        private static IEnumerable<LineMetadataTableEntry> LineMetadataTableEntriesFromCompilationResult(CompilationResult result)
        {
            ...
            {
                var meta = YarnEditorUtility.InstanceScript<LineMetadataTableEntry>("res://addons/YarnDonut/Runtime/LineMetadataTableEntry.cs");
                meta.ID = x.Key;
        ...
        private static IEnumerable<StringTableEntry> GetStringTableEntries(YarnProject project, CompilationResult result)
        {
            ...
            return result.StringTable.Select(x =>
                {
                    var entry = YarnEditorUtility.InstanceScript<StringTableEntry>("res://addons/YarnDonut/Runtime/StringTableEntry.cs");
