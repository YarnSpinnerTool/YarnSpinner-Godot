...
namespace YarnDonut
{
    ...
    /// </summary>
    [Serializable] [Tool]
    public class LineMetadataTableEntry : Resource
    {
                ...
                using (var csv = new CsvReader(stringReader, GetConfiguration()))
                {
                    ...
                    */
                    ...
                    while (csv.Read())
                    {
                        ...
                        var record = YarnEditorUtility.InstanceScript<LineMetadataTableEntry>("res://addons/YarnDonut/Runtime/LineMetadataTableEntry.cs");
