...
/// </remarks>
public class YarnSpinnerProjectSettings
{
    ...
    internal static YarnSpinnerProjectSettings GetOrCreateSettings(string? path = null, YarnSpinnerGodot.ILogger? iLogger = null)
    {
    ...
    private static YarnSpinnerProjectSettings FromJson(string jsonString, YarnSpinnerGodot.ILogger? iLogger = null)
    {
        var logger = ValidLogger(iLogger);
    ...
    internal void WriteSettings(string? path = null, YarnSpinnerGodot.ILogger? iLogger = null)
    {
        var logger = ValidLogger(iLogger);
    ...
    private static YarnSpinnerGodot.ILogger ValidLogger(YarnSpinnerGodot.ILogger? iLogger)
    {
        var logger = iLogger;
        if (logger == null)
        {
